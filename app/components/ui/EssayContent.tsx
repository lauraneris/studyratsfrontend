...
const EssayContent = ({ theme, text }: EssayContentProps) => {
    return (
        <div>
            ...
            <h1 className="text-4xl font-black text-brand-pink mb-4">Sua redação</h1>
            ...
            <button className="mt-8 bg-brand-blue text-white font-bold py-3 px-6 rounded-lg hover:brightness-110 transition-colors">
                Reescrever
            </button>
        </div>
    );
