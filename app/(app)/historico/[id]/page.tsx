...
const mockCorrection = {
    ...
    criteria: [
        { number: 1, score: 200, maxScore: 200, content: 'Você utilizou operadores argumentativos e elementos coesivos para conectar suas ideias de forma lógica e fluida. Sua proposta de intervenção é pertinente e mostra um bom entendimento do problema abordado.', isPerfect: true },
        { number: 2, score: 180, maxScore: 200, content: 'O critério 2 poderia ser melhorado com mais exemplos práticos para sustentar sua tese principal.', isPerfect: false },
    ]
};
